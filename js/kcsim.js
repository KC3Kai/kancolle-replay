...
var COMBINEDCONSTS = {
	0: {
		'ecombined': {
			...
			'escort': { 'shellDmgF': 5, 'shellDmgE': -5, 'shellAccF': 80, 'shellAccE': 70 },
		},
	},
	1: {
		'esingle': {
		...
		'ecombined': {
			...
			'escort': { 'shellDmgF': -5, 'shellDmgE': -5, 'shellAccF': 67, 'shellAccE': 70 },
		},
	},
	2: {
		'esingle': {
...
function torpedoPhase(alive1,subsalive1,alive2,subsalive2,opening,APIrai,combinedAll) {
	...
	for (var i=0; i<shots.length; i++) {  //do the shots
		...
		if (combinedAll && ship.side == 0 && !ship.fleet.combinedWith) accflat -= 35;
